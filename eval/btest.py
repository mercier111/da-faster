...
if __name__ == "__main__":
    ...
    if args.net == "vgg16":
        ...
        fasterRCNN = resnet(
            imdb.classes, 101, pretrained=False, class_agnostic=args.class_agnostic, source_bayes=args.source_bayes, target_bayes=args.target_bayes,
        )
    elif args.net == "res50":
        fasterRCNN = resnet(
    ...
    for i in range(num_images):
        ...
        ) = fasterRCNN(im_data, im_info, gt_boxes, num_boxes, im_data, im_info, gt_boxes, num_boxes)
        

        scores = fake_source_cls_prob.data
        boxes = fake_source_rois.data[:, :, 1:5]

        if cfg.TEST.BBOX_REG:
            # Apply bounding-box regression deltas
            box_deltas = fake_source_bbox_pred.data
