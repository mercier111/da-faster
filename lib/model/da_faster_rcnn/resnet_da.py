...
model_urls = {
    ...
    "resnet101": "dataset/pretrained_model/resnet101.pth",
...
class resnet(_fasterRCNN):
    def __init__(self, classes, num_layers=101, pretrained=False, class_agnostic=False, bayes=0):
        self.model_path = "dataset/pretrained_model/resnet101.pth"
        self.dout_base_model = 1024
        self.pretrained = pretrained
        self.class_agnostic = class_agnostic

        _fasterRCNN.__init__(self, classes, class_agnostic, 2048, bayes)
